    ...
    <section id="about">
        <div class="content-box-md">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p>Web developer who uses a range of technologies and has experience working and managing projects. <strong>
                ...
                <div class=" col-md-6 text-center">
                            <img src="{{asset('assets/image/profile/basheer.jpg')}}" alt="John Doe" />
                    </div>
                </div>
                <div id="progress-elements">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="skill">
                                    <h4>Bootstrap / Semantic UI / Bulma</h4>
                                    <div class="progress">
                            ...
                            <div class="col-md-12">
                                <div class="skill">
                                    <h4>JavaScript / jQuery / Vue.js</h4>
                                    <div class="progress">
                ...
                <div class="container-fluid">
                    <div class="row no-gutters">
                        <div id="isotope-container">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 design front">
                                <div class="portfolio-item">
                                    <a href="#" title="portfolio" target="_blank">
                                        <img src="{{asset('assets/image/portfolio/portfolio-01.png')}}" class="img-responsive" alt="portfolio" />
                                        <div class="portfolio-item-overlay">
                                    ...
                                    <div class="post-meta">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-8 col-xs-6 post-author">
                                                <p><img src="{{asset('assets/image/blog/author.webp')}}" alt="author" class="img-circle" />Basheer Faidi</p>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="author-img">
                                                <img src="{{asset('assets/image/testimonials/testimonial.jpg')}}" alt="client" class="img-circle" />
                                            </div>
